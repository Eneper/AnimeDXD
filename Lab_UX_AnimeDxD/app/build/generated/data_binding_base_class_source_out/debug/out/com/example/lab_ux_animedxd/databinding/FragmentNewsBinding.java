...
public final class FragmentNewsBinding implements ViewBinding {
  ...
  private FragmentNewsBinding(@NonNull LinearLayout rootView,
      @NonNull ViewPager2 carouselViewPager) {
  ...
  public static FragmentNewsBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.carouselViewPager;
      ViewPager2 carouselViewPager = ViewBindings.findChildViewById(rootView, id);
      if (carouselViewPager == null) {
        break missingId;
      }

      return new FragmentNewsBinding((LinearLayout) rootView, carouselViewPager);
    }
