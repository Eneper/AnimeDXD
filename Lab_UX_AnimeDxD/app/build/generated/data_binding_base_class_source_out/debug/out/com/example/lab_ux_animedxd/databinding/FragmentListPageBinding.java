...
public final class FragmentListPageBinding implements ViewBinding {
  ...
  @NonNull
  public static FragmentListPageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentListPageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_list_page, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentListPageBinding bind(@NonNull View rootView) {
